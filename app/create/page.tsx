...
export default function page() {
  ...
  const onSubmit = (e: FormEvent) => {
    ...
    axios
      .post('http://localhost:8080/api/v1/course', state)
      .then(() => {
  ...
  return (
    <div className="flex justify-center">
      <div className="flex flex-col h-[900px]">
        <form className="w-[600px] py-12 flex flex-col items-center gap-4">
          <div className="flex flex-col gap-2 py-4 w-full">
            ...
            <Input
              ...
              onChange={handleChange}
            />
            {/* Use the handleCheckboxChange function for the checkbox */}
        ...
        <Button label="Create" onClick={onSubmit} disabled={loading} />
      </div>
    </div>
  )
}